...
export default class PublicRequest {
	...
	public static postData = async (payload: any, path: string) => {
		return AxiosHandler.getResponse(200, AxiosHandler.vPostRequest, path, payload);
	};
	public static postCategoriesData = async (payload: any, path: string) => {
		return AxiosHandler.getResponse(200, AxiosHandler.vPostCategoriesRequest, path, payload);
	};

	public static putData = async (payload: any, path: string) => {
		return AxiosHandler.getResponse(200, AxiosHandler.vPutRequest, path, payload);
	};
	...
	public static putDataWithNoFormData = async (payload: any, path: string) => {
		return AxiosHandler.getResponse(200, AxiosHandler.vPutwithNotFormdataRequest, path, payload);
	};
