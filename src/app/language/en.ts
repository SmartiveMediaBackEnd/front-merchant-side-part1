export const english = {
	...
	'Answer question people frequently ask about your product.': 'Answer question people frequently ask about your product.',
	...
	'add question': 'add question',
	'Q&A': 'Q&A',
	"Enable this option if the product needs to be physically delivered to customers either via shipping or by self-pickup. If this product is a service or a downloadable item that doesn’t require delivery, keep this option disabled.":"Enable this option if the product needs to be physically delivered to customers either via shipping or by self-pickup. If this product is a service or a downloadable item that doesn’t require delivery, keep this option disabled.",
	'Dimension':'Dimension',
	'add more specifications':'add more specifications',
	'add specification':'add specification',
};
